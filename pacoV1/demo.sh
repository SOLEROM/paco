...
echo "📅 Step 5: Add daily notes to project"
python3 "${SCRIPT_DIR}/paco" daily $PROJECT "Morning: Working on demo project"
python3 "${SCRIPT_DIR}/paco" daily $PROJECT "Had a breakthrough on architecture"
echo ""
...
echo "  paco summarize ${PROJECT}               # Generate summary"
echo ""
